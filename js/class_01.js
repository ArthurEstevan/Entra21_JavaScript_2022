...
// console.log("Arthur "+19+" anos"); //É possível concatenar textos e variáveis igual ao java
// console.log("Arthur",19,"anos"); //O console aceita infinitos parâmetros basta separar por virgula
